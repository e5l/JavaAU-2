...
public final class Client {
    ...
    public void measure(final BenchmarkParamsOuterClass.BenchmarkParams params) throws IOException {
        InitResponseOuterClass.InitResponse initResponse = initTestServer(params);
        runBenchmarks(params, initResponse.getPort());
    }

    private void runBenchmarks(BenchmarkParamsOuterClass.BenchmarkParams params, int port) {
